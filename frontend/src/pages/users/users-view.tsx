    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Documents User</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.documents_user &&
                      Array.isArray(users.documents_user) &&
                      users.documents_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
          ...
          <>
            <p className={'block font-bold mb-2'}>Reminders User</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.reminders_user &&
                      Array.isArray(users.reminders_user) &&
                      users.reminders_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
